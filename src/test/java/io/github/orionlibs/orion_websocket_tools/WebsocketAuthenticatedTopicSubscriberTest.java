...
public class WebsocketAuthenticatedTopicSubscriberTest
{
    @LocalServerPort
    private int port;
    ...
    void testAuthenticatedWebSocketConnection() throws Exception
    {
        ...
        connectHeaders.add("login", "websocketuser");
        connectHeaders.add("passcode", "websocketpassword");
        ...
        StompSession session = stompClient.connectAsync(url, handshakeHeaders, connectHeaders, new StompSessionHandlerAdapter()
        {
            @Override
